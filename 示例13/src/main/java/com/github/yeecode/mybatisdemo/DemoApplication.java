...
@SpringBootApplication public class DemoApplication {
    public static void main(String[] args) {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            userBean = session
                .selectOne("com.github.yeecode.mybatisdemo.dao.UserDao.selectUserByNameAndSchoolName", userParam);
            ...
            List<User> userList = session
                .selectList("com.github.yeecode.mybatisdemo.dao.UserDao.selectUsersByNameOrSchoolName", userParam);
