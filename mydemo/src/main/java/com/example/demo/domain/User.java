...
@TableName(value = "user") @Data public class User implements Serializable {
     ...
     *
     */
    @TableField(value = "sex") private Integer sex;

    /**
     *
     */
    @TableField(value = "schoolName") private String schoolName;

    /**
     *
     */
    @TableField(value = "gmt_create") private LocalDateTime gmt_create;
